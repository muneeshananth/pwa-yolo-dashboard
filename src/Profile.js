...
export default class Profile extends Component {
  ...
  uploadeimage = (e) => {
    ...
    try {
      ...
      axios
        .post("http://localhost:5000/guest_image/:id", data)
        .then((res) => {
          console.log(res);
          if (res.status == 200) {
  ...
  updateaboutme = (e) => {
    ...
    axios
    .post("http://localhost:5000/guest_about_me/1", data)
    .then((res) => {
      console.log(res);
      if (res.status == 200) {
  ...
  updateoccuption = (e) => {
    ...
    axios
    .post("http://localhost:5000/guest_occupation/1", data)
    .then((res) => {
      console.log(res);
      if (res.status == 200) {
  ...
  updatephnonenumber = (e) => {
    ...
    axios
    .post("http://localhost:5000/guest_mobile_number/1", data)
    .then((res) => {
      console.log(res);
      if (res.status == 200) {
  ...
  updatemailid = (e) => {
    ...
    axios
    .post("http://localhost:5000/guest_email/1", data)
    .then((res) => {
      console.log(res);
      if (res.status == 200) {
